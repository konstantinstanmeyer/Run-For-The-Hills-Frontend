        ...
        <div>
            ...
            <div className="h-[600px] w-1/4 bg-white float-right md:mr-44 mt-10 rounded-md sm:mr-2">
                ...
                <form onSubmit={handleSubmit} className="relative flex flex-col justify-center">
                    ...
                    <img onClick={closed => setClosed(!closed)} className="h-6 w-6 relative ml-auto -top-11 right-[20%]" src={closed ? "https://cdn-icons-png.flaticon.com/512/2356/2356734.png" : "https://cdn-icons-png.flaticon.com/512/709/709612.png"}/>
